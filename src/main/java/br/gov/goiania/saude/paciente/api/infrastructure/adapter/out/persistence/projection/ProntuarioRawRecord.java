...
public record ProntuarioRawRecord(
    ...
    @Override
    public String getProfissionalRegistro() {
        return profissionalRegistro;
    }

    @Override
    public String getProfissionalTipoConselho() {
        return profissionalTipoConselho;
    }

    @Override
    public String getProfissionalCbo() {
        return profissionalCbo;
    }

    @Override
    public String getProfissionalCboDescricao() {
        return profissionalCboDescricao;
    }
    ...
    @Override
    public Integer getRegistroTipoId() {
        return registroTipoId;
    }

    @Override
    public String getRegistroConteudo() {
        return registroConteudo;
    }

    @Override
    public String getClassificacaoRiscoNome() {
        return classificacaoRiscoNome;
    }

    @Override
    public LocalDateTime getAihDataCadastro() {
        return aihDataCadastro;
    }

    @Override
    public String getAihPrincipaisSinais() {
        return aihPrincipaisSinais;
    }

    @Override
    public String getAihCondicoesInternacao() {
        return aihCondicoesInternacao;
    }

    @Override
    public String getAihPrincipaisResultados() {
        return aihPrincipaisResultados;
    }

    @Override
    public String getAihDiagnosticoInicial() {
        return aihDiagnosticoInicial;
    }

    @Override
    public Boolean getPossuiAih() {
        return possuiAih;
    }
}
